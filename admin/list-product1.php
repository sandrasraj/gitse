                                            ...
                                            <?php while ($productsRow = mysqli_fetch_assoc($resultproducts)) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $productsRow['create_date'] ?></td>
                                                     ...
                                                     <td>
                                                        <a href="change-product1.php?id=<?= $productsRow['id']?>" class="btn btn-default btn-success"> <i class="fa fa-edit"></i></a>
                                                  
                                                    <td>
                                             
                                                        <a href="edit-product1.php?id=<?= $productsRow['id'] ?>" class="btn btn-default btn-success"> <i class="fa fa-edit"></i></a></a>
                                                        <a href="javascript:void(0)" onclick="deleteConfirm('delete-product1.php?id=<?= $productsRow['id'] ?>')" class="btn btn-default btn-danger"> <i class="fa fa-remove"></i></a>
                                                    </td>
                                                </tr>
                                                <?php $i++;
                                            }
...
<?php } ?>
                                ...
                                <div class="box-footer clearfix">
                                    <ul class="pagination pagination-sm no-margin pull-right">
                                        <li><a href="list-product1.php?page=1">&laquo;</a></li>
                                        <?php
                                        for ($i = 1; $i <= $total_page; $i++) {
                                            ?>
                                            <li><a href="list-product1.php?page=<?= $i ?>"><?= $i ?></a></li>
<?php } ?>
                                        <li><a href="list-product1.php?page=<?= $total_page ?>">&raquo;</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- /.box -->
