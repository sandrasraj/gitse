                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <?php
                                $limit = 10;
                                $sqlbrandsCnt = sprintf("SELECT count(*) as cnt FROM brands");
                                $resultCount = mysqli_query($link, $sqlbrandsCnt);
                                ...
                                $sqlbrands = sprintf("SELECT * from brands LIMIT $start, $limit");
                                ...
                                if (mysqli_num_rows($resultbrands) > 0) {
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <?php while ($brandsRow = mysqli_fetch_assoc($resultbrands)) { ?>
                                                <tr>
                                                    <td><?= $i ?></td>
                                                    <td><?php echo $brandsRow['brandname'] ?></td>
                                                    <td><?php echo $brandsRow['description'] ?></td>
                                                    <td><?php echo $brandsRow['create_date'] ?></td>
                                                     <td><?php echo $brandsRow['update_date'] ?></td>
                                                     <td>
...
<?php } ?>
                                ...
                                <div class="box-footer clearfix">
                                    <ul class="pagination pagination-sm no-margin pull-right">
                                        <li><a href="list-brand.php?page=1">&laquo;</a></li>
                                        <?php
                                        for ($i = 1; $i <= $total_page; $i++) {
                                            ?>
                                            <li><a href="list-brand.php?page=<?= $i ?>"><?= $i ?></a></li>
<?php } ?>
                                        <li><a href="list-brand.php?page=<?= $total_page ?>">&raquo;</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- /.box -->
